...
function PlansScreen() {
    ...
    const loadCheckout = async (priceId) => {
        ...
        docRef.onSnapshot(async(snap) => {
            ...
            //Show an error to ypur customer and
            ...
            if (sessionId) {
                ...
                //init stripe
                const stripe = await loadStripe('pk_test_51IpBG6F7rFFQ0yF4ABDZcRGEge7Zk6VonKB0yrYvjGdxGpcR5W0RmIUcS8vPj56m000A9KgGUcbeYCAIl9zmModC0059oX9PXL');
